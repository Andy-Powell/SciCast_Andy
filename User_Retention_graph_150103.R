...
open <- ceiling(as.double(as.POSIXlt("2015-01-31 00:00:00 EDT")-rstart)/30.5)              #need to automate
month <-c("Dec","Jan","Feb","Mar","Apr","May","Jun","Jul","Aug","Sep","Oct","Nov","Dec")   #need to automate
