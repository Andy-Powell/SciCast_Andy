...
plot(activity$mids,activity$counts, type='h', lwd=10, lend=2,col=rgb(1,0,0,0.5),log="xy", xlab="Questions Forecast per Active User", ylab="Number of Questions",main=paste("Questions Forecast per Active User, ",expStart," to ",trunc(expStop-24*60*60,"days"),sep=""))               
