...
source("Incentive Experiment lastTrade Data 150220.R")
...
##### Setting experimental questions
...
source("Incentive Accuracy Active All Q 141209B.R")
source("Incentive Accuracy Control All Q 141209B.R")
...
br <- seq(0,2,0.1)
title <- paste("Incentive Accruacy All Q  ", expStart,"--",expStop,sep="",".png")
...
barplot(count,beside=T,col=c(rgb(1,0,0,0.5),rgb(0,0,1,0.5)),xlab="Brier Score",
        ylab="Number of Questions",cex.main=1,main=paste("Accuracy All Q ",expStart," to ",expStop,sep=""))
