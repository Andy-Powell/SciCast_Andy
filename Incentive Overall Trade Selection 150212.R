...
# requires tat, modifies tat, tit, pit, qit, nvt, ovt, ast, apot, cit, rst, mdt, asqt, asot
# Generates tat for
#   experiment period tatExp[expStart, expStop]
#   periods Q1 & Q3 (tatAAct)
#   periods Q2 & Q4 (tatACon)
#    
#
####################################################
start <- Sys.time() 
